...
def page4(genre,df5,wb,save_dir):
    ...
    if col1.button('Run gaussian fit'):   
        ...
        try:
            ...
            if sele == "選択data 出力":     
                for i in range(0,3,1):
                    ...
                    if data[3]['R^2'][i] >= r:
                        ...
                        data_raw = convert.convert_df(data_raw)
                        data_para = convert.convert_df(data_para)
                        
                        col3.download_button(
                        label="Download fitting result as CSV",
                        data= data_raw,
                        ...
                        col3.download_button(
                        label="Download fitting parameter result as CSV",
                        data= data_para,
                        file_name="fitting_parameter.csv",
                        mime="text/csv",
                        )
            ...
            st.write('フィッティングが収束しませんでした。初期値を見直してください。')
